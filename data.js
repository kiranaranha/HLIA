...
distances = [[0, 3.5, 2.4, 0.7, 1.0, 0.6, 1.7, 1.4, 0.8],
            ...
            [2.4, 2.1, 0, 2.9, 3.2, 2.0, 2.0, 3.5, 5.6],
            [0.7, 4.0, 2.9, 0, 0.9, 1.0, 2.0, 0.9, 0.5],
            [1.0, 4.7, 3.2, 0.9, 0, 1.3, 1.4, 0.4, 0.6],
            [0.6, 3.4, 2.0, 1.0, 1.3, 0, 1.2, 1.6, 2.9],
            [1.7, 3.7, 2.0, 2.0, 1.4, 1.2, 0, 1.5, 2.6],
            [1.4, 5.0, 3.5, 0.9, 0.4, 1.6, 1.5, 0, 1.3],
            [0.8, 6.8, 5.6, 0.5, 0.6, 2.9, 2.6, 1.3, 0]];
